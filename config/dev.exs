...
config :partaches, PartachesWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "EO0ftdKVymT3fBmDI6DcngMuS326pRfCge4JqOXB6FpLYKaCiR2+rSIqDTnfxiht",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:partaches, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:partaches, ~w(--watch)]}
  ]
...
config :partaches, PartachesWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/partaches_web/router\.ex$"E,
      ~r"lib/partaches_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :partaches, dev_routes: true
